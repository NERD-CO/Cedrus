...
disp("Raising all output lines for 1 millisecond.")
...
% write(device,sprintf("mh%c%c", 50, 0), "char") % 50 = trial start
% write(device,sprintf("mh%c%c", 100, 0), "char") % 100 = button press
